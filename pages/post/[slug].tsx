        ...
        <main>
            ...
            {submitted ? (
                <div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
                    <h3 className="text-3xl font-bold">Thank you for writing</h3>
                ...
                <label className="black mb-5">
                    ...
                    <textarea
                        ...
                        className="shadow border rounded py-2 px-3 form-textarea mt-1 block w-full ring-yellow-500 outline-none focus:ring" placeholder="Your comment" rows={8} />
                </label>
